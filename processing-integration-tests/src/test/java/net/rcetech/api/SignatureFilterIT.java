...
class SignatureFilterIT extends ApiBaseIntegrationTest {
    ...
    void setUpAuth() {
        ClientByApiKeyDTO mockClient = ClientByApiKeyDTO.builder()
                ...
                .apiKeyPreview("prof...")
                .secret(ApiBaseIntegrationTest.CLIENT_SECRET)
    ...
    void shouldReturn401Unauthorized_WhenSignatureOrTimestampHeaderIsMissing() {
        webTestClient.post()
                .uri("/orders")
                .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "Api-Key " + ApiBaseIntegrationTest.API_KEY)
                .bodyValue("{}")
                .exchange()
