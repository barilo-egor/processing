package tgb.cryptoexchange.processingdetailsapi.controller;
...
import tgb.cryptoexchange.processingdetailsapi.dto.CreateOrderDTO;
import tgb.cryptoexchange.processingdetailsapi.dto.OrderResponseDTO;
import tgb.cryptoexchange.processingdetailsapi.service.OrderService;
...
public class OrdersController {
     ...
     *                           {@link tgb.cryptoexchange.processingdetailsapi.config.security.ApiSignatureFilter}.
     ...
     * @throws tgb.cryptoexchange.processingdetailsapi.exceptions.OrderNotFoundException если заказ не найден ни по одному из идентификаторов.
     */
    @GetMapping("/{id}")
     ...
     * @throws tgb.cryptoexchange.processingdetailsapi.exceptions.OrderNotFoundException если отменяемый заказ не найден в системе.
     */
    @PatchMapping("/{id}")
