...
class SupportCookieServiceTest {
    ...
    @InjectMocks
    private SupportCookieService supportCookieService;

    private void initServiceWithTtl() {
        ReflectionTestUtils.setField(supportCookieService, "refreshExpiration", refreshExpiration);
    }
    ...
    void should_createStrictSecureCookie_when_profileIsProd() {
        ...
        ResponseCookie cookie = supportCookieService.createRefreshTokenCookie(token);
