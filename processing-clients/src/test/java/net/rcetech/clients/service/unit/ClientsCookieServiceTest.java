...
class ClientsCookieServiceTest {
    ...
    @InjectMocks
    private ClientsCookieService clientsCookieService;

    private void initServiceWithTtl() {
        ReflectionTestUtils.setField(clientsCookieService, "refreshExpiration", refreshExpiration);
    }
    ...
    void should_createStrictSecureCookie_when_profileIsProd() {
        ...
        ResponseCookie cookie = clientsCookieService.createRefreshTokenCookie(token);
